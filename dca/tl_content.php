...
$GLOBALS['TL_DCA']['tl_content']['palettes']['inlinemediaivvimeo'] = '{type_legend},type,headline;{inlinemedia_legend},inlinemedia_source,inlinemedia_media_vi,inlinemedia_width,inlinemedia_height,inlinemedia_autoplay,inlinemedia_loop,inlinemedia_color,inlinemedia_params;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop';
$GLOBALS['TL_DCA']['tl_content']['palettes']['inlinemediaivyoutube'] = '{type_legend},type,headline;{inlinemedia_legend},inlinemedia_source,inlinemedia_media_yt,inlinemedia_width,inlinemedia_height,inlinemedia_autoplay,inlinemedia_suggest,inlinemedia_privacy,inlinemedia_params;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop';
...
$GLOBALS['TL_DCA']['tl_content']['palettes']['inlinemediaivsoundcloud'] = '{type_legend},type,headline;{inlinemedia_legend},inlinemedia_source,inlinemedia_media_sc,inlinemedia_autoplay,inlinemedia_artwork,inlinemedia_color,inlinemedia_params;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop';
